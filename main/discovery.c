...
#ifndef MODULE_TYPE
#error "MODULE_TYPE must be defined (e.g., \"plateau\")"
#endif

// CAN TX ID for status messages (fixed for Plateau)
#define CAN_STATUS_ID  0x32
...
// ---------------------------------------------------------------------------
// Discovery task — runs on its own FreeRTOS task to avoid blocking CAN
// ---------------------------------------------------------------------------
