 ...
 * If this module has WiFi credentials, spawns a task that joins WiFi,
 * advertises via mDNS with module metadata, and waits for Headwaters
 * to confirm registration.
 * Returns immediately — does not block the CAN task.
 */
